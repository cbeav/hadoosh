 ...
 *  </p>
 *  <pre>
 *  myConsoleReader.addCompletor (new SimpleCompletorWithoutSpace (new String [] { "now", "yesterday", "tomorrow" }));
 *  </pre>
 *
 *  @author  <a href="mailto:mwp1@cornell.edu">Marc Prud'hommeaux</a>
 */
public class SimpleCompletorWithoutSpace implements Completor, Cloneable {
    /**
     ...
     */
    String delimiter;
    final SimpleCompletorWithoutSpaceFilter filter;

    /**
     *  Create a new SimpleCompletorWithoutSpace with a single possible completion
     *  values.
     */
    public SimpleCompletorWithoutSpace(final String candidateString) {
        this(new String[] {
                 candidateString
             });
    }
    ...
    /**
     *  Create a new SimpleCompletorWithoutSpace with a list of possible completion
     *  values.
     */
    public SimpleCompletorWithoutSpace(final String[] candidateStrings) {
        this(candidateStrings, null);
    }

    public SimpleCompletorWithoutSpace(final String[] strings,
                           final SimpleCompletorWithoutSpaceFilter filter) {
        this.filter = filter;
     ...
     */
    public SimpleCompletorWithoutSpace(final Reader reader) throws IOException {
     ...
     */
    public SimpleCompletorWithoutSpace(final InputStream in) throws IOException {
     ...
     *  @author  <a href="mailto:mwp1@cornell.edu">Marc Prud'hommeaux</a>
     */
    public static interface SimpleCompletorWithoutSpaceFilter {
        /**
    ...
    public static class NoOpFilter implements SimpleCompletorWithoutSpaceFilter {
